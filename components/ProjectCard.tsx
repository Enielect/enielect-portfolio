...
const ProjectCard = () => {
  return (
    <div className="w-[32rem] p-4 pb-5 h-[35rem] text-white rounded-lg bg-[rgba(255,255,255,0.1)] backdrop-blur-[10px] border border-white border-opacity-20">
      ...
      <div className="pb-[10px] pt-[10px] text-left">
        ...
        <h3 className="text-2xl py-2 border-[rgba(255,255,255,0.1)] border-b">
          Agro Predict
        </h3>
      </div>
